    ...
    Container(
      ...
      child: Builder(
        builder: (_) => ListTile(
          ...
          leading: CircleAvatar(child: Icon(Icons.logout,color: Colors.brown),backgroundColor: Color(0xffF2EFE4),),
          title: Text(
            "log out",
    ...
    Container(
      ...
      child: Builder(
        builder: (_) => ListTile(
          ...
          title: Text(
            "patch profile",
            style: TextStyle(color: Colors.brown,backgroundColor:Color(0xffF2EFE4),fontSize: 20),
          ),
        ),
      ),
    ),
    Container(
      ...
      child: Builder(
        builder: (_) => ListTile(
          ...
          leading: CircleAvatar(child: Icon(Icons.calendar_today,color: Colors.brown),backgroundColor: Color(0xffF2EFE4),
          ),
          title: Text("Schedule", style: TextStyle(color: Colors.brown,backgroundColor:Color(0xffF2EFE4),fontSize: 20),),
        ),
      ),
    ),
    Builder(
      builder: (_) => ListTile(
        ...
        leading: CircleAvatar(child: Icon(Icons.face_retouching_natural,color: Colors.brown),backgroundColor: Color(0xffF2EFE4),),

        title: Text("invite friends", style: TextStyle(color: Colors.brown,backgroundColor:Color(0xffF2EFE4),fontSize: 20),),
      ),
    ),
    ListTile(

      leading: CircleAvatar(child: Icon(Icons.motorcycle_rounded,color: Colors.brown),backgroundColor: Color(0xffF2EFE4),),
      title: Text("Catch-A-Ride", style: TextStyle(color: Colors.brown,backgroundColor:Color(0xffF2EFE4),fontSize: 20),),
    ),
    ListTile(
      tileColor: newcolor,
      leading: CircleAvatar(child: Icon(Icons.report,color: Colors.brown),backgroundColor: Color(0xffF2EFE4),),
      title: Text("Emergency", style: TextStyle(color: Colors.brown,backgroundColor:Color(0xffF2EFE4),fontSize: 20),),
    ),
    ListTile(
      tileColor: newcolor,
      leading: CircleAvatar(child: Icon(Icons.work,color: Colors.brown),backgroundColor: Color(0xffF2EFE4),),
      title: Text("Active Projects", style: TextStyle(color: Colors.brown,backgroundColor:Color(0xffF2EFE4),fontSize: 20),),
    ),
    Container(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Add Event Details",style: TextStyle(color: Colors.brown),),
...
class _MyRiveAnimationState extends State<MyRiveAnimation> {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        image: DecorationImage(image: AssetImage("Assets/Frame 4.png"), fit: BoxFit.cover,),
      ),
