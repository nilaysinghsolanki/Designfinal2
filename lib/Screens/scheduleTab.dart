  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Your Schedule",style:TextStyle(
          color: Colors.brown,
        ),),
                        ...
                        child: AnimationConfiguration.staggeredList(
                            ...
                            child: SlideAnimation(
                                child: FlipAnimation(
                                    flipAxis: FlipAxis.y,
                                    child: Container(
                                      decoration: lectures[index].free ?BoxDecoration(
                                          borderRadius: BorderRadius.circular(5),

                                          border: Border(
                                              top: BorderSide(width: 2,color: Colors.lightGreen),
                                              bottom:BorderSide(width: 2,color:Colors.lightGreen),
                                              right: BorderSide(width: 2,color: Colors.lightGreen),
                                              left:BorderSide(width: 2,color: Colors.lightGreen)
                                          )
                                      ):BoxDecoration(
                                        borderRadius: BorderRadius.circular(5),

                                        border: Border(
                                          top: BorderSide(width: 2,color: Colors.brown),
                                          bottom:BorderSide(width: 2,color: Colors.brown),
                                          right: BorderSide(width: 2,color: Colors.brown),
                                          left:BorderSide(width: 2,color: Colors.brown)
                                        )
                                      ),
                                      ...
                                      child: ListTile(
                                          ...
                                          title: lectures[index].free
                                              ...
                                              : Text(lectures[index].name,style: TextStyle(
